<template>
  <div class="hello">
    ...
    <span v-if="entryHash">Created new Holochain entry! consumer with hash {{ entryHash }}</span>
...
export default defineComponent({
  ...
  async mounted() {
    ...
    const cellData = info.cell_data.find(data => data.role_id === 'ioen_micro_ledger') as InstalledCell;
